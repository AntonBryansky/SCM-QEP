...
M_mat = get_Lamb_M_matrix(N, density);      % M matrix does not depend on the wavenumber
M_mat = set_Lamb_M_BC(M_mat, N);            % Setting boundary conditions for M matrix

% L matrices and setting boundary conditions
[L0, L1, L2] = get_Lamb_L_coeffs(c, I_N, DM1, DM2);
[S0, S1] = get_Lamb_S_coeffs(c, I_N, DM1);
[L0_bc, L1_bc, L2_bc] = set_coeffs_Lamb_BC(L0, L1, L2, S0, S1, N);
